...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = KEYMAP(
      ...
      KC_LCTL, KC_LALT, KC_LGUI,          KC_SPC,                KC_RALT, KC_RGUI, MO(_L1), KC_RCTL,                            KC_LEFT, KC_DOWN, KC_RGHT),
      ...
      _______, _______, _______,          _______,                   _______, _______, _______, _______,                            KC_MUTE, KC_VOLD, KC_MSTP),
};

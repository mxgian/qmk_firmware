...
/*
PCB is minivan hotswap, but MHKB has blockers so bottom left and bottom right keys are blocked
*/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT_arrow_command( /* Qwerty */
    ...
    KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI,   LT(_L1,KC_BSPC),  LT(_L2,KC_SPC),           KC_RGUI,  KC_RALT, KC_RCTL, _______
  ),
  ...
  [_L2] = LAYOUT_arrow_command( /* LAYER 2 */
    ...
    _______, _______, _______, _______,                  _______, _______,          KC_MNXT, KC_VOLD, KC_VOLU, _______
  ),
  [_L3] = LAYOUT_arrow_command( /* LAYER 3 */
    ...
    KC_LSFT, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_VOLD,
    _______, RESET, KC_B, _______,                     _______,  _______,              _______,KC_VOLD, KC_VOLU, _______
  )
};
